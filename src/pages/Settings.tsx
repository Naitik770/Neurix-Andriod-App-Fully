        ...
        <div className="bg-white dark:bg-gray-800 rounded-3xl p-6 shadow-sm transition-colors duration-300">
          ...
          <div className="grid grid-cols-2 gap-3">
            <button 
              ...
              className="p-3 text-left bg-gray-50 hover:bg-orange-50/50 dark:bg-gray-700 dark:hover:bg-gray-650 rounded-2xl transition-all"
            >
              <span className="block text-sm font-bold text-gray-800 dark:text-gray-200">About Us</span>
            ...
            <button 
              ...
              className="p-3 text-left bg-gray-50 hover:bg-orange-50/50 dark:bg-gray-700 dark:hover:bg-gray-650 rounded-2xl transition-all"
            >
              <span className="block text-sm font-bold text-gray-800 dark:text-gray-200">Contact</span>
            ...
            <button 
              ...
              className="p-3 text-left bg-gray-50 hover:bg-orange-50/50 dark:bg-gray-700 dark:hover:bg-gray-650 rounded-2xl transition-all"
            >
              <span className="block text-sm font-bold text-gray-800 dark:text-gray-200">Privacy Policy</span>
            ...
            <button 
              ...
              className="p-3 text-left bg-gray-50 hover:bg-orange-50/50 dark:bg-gray-700 dark:hover:bg-gray-650 rounded-2xl transition-all"
            >
              <span className="block text-sm font-bold text-gray-800 dark:text-gray-200">Terms of Use</span>
