    ...
    <div className="bg-[#FDFBF7] dark:bg-gray-950 text-gray-900 dark:text-gray-100 min-h-screen font-sans pb-20 transition-colors duration-300">
      ...
      <main className="max-w-4xl mx-auto px-6 pt-12 space-y-10">
        ...
        <div className="grid md:grid-cols-2 gap-4 text-sm">
          ...
          <div className="p-5 bg-white dark:bg-gray-900 rounded-2xl border border-orange-100/30 dark:border-gray-850 flex gap-4 items-start">
            ...
            <div>
              ...
              <span className="text-xs text-gray-500 dark:text-gray-400">NAITIX AI is an educational tool. We are not medical practitioners. Our feedback loops have no diagnostics validity.</span>
            </div>
          </div>
        </div>
        ...
        <article className="prose dark:prose-invert prose-orange max-w-none text-gray-650 dark:text-gray-300 space-y-6 text-sm sm:text-base leading-relaxed">
          <p>
            Welcome to NAITIX AI! These Terms and Conditions outline the rules and regulations for the use of NAITIX AI's brain tracking platform and associated software tools.
          </p>
          <p>
            By accessing this web application, we assume you accept these terms and conditions in full. Do not continue to use NAITIX AI if you do not agree to take all of the terms and conditions stated on this page.
          </p>
          ...
          <ul className="list-disc pl-6 space-y-1">
            ...
            <li><strong>"The Company", "Ourselves", "We", "Our", and "Us"</strong> refers to NAITIX AI.</li>
          ...
          <p>
            NAITIX AI is an interactive platform displaying habit tracking, physical biometrics profiles, personalized artificial conversations, and 10+ custom brain conditioning games (Cognitive Load, Color Match, Memory Matrix, Reaction Time, spatial reasoning).
          </p>
          <p>
          ...
          <p>By creating a NAITIX AI handle/username, you agree to:</p>
          ...
          <p>
            NAITIX AI gamifies self-improvement through "Experience Points" (XP), "Levels", and "XP Streaks". You agree that:
          </p>
          <p>
          ...
          <div className="bg-orange-50/40 p-4 border-l-4 border-orange-500 rounded-r-2xl text-xs sm:text-sm">
            ...
            <p className="text-orange-700 leading-relaxed mt-1">
              NAITIX AI is an educational, fun self-help tool. It does not contain or constitute medical advice, diagnostic checklists, therapeutic counseling, or clinical evaluations. The cognitive games are designed in the spirit of light mental gymnastics and are not cleared, verified, or recommended as therapies for neurological conditions, ADHD, memory loss, dementia, or clinical attention disorders. Always seek professional physician guidance for any underlying health complaints.
            </p>
          </div>

          <h2 className="text-xl font-bold text-gray-950 dark:text-white pt-4">6. Third-Party Ads (Google AdSense) & Cookies</h2>
          <p>
            We display context-based visual ads to offset backend server and API token costs. By using NAITIX AI, you acknowledge that our advertising partner, Google AdSense, utilizes cookies to present non-obtrusive, appropriate ads customized to your approximate locale or web history. For further information, review our <Link to="/privacy-policy" className="text-orange-500 font-bold hover:underline">Privacy Policy</Link>.
          </p>

          <h2 className="text-xl font-bold text-gray-950 dark:text-white pt-4">7. Intellectual Property & Code Restrictions</h2>
          <p>
            Unless otherwise stated, NAITIX AI and/or its licensors own the intellectual property rights for all material on NAITIX AI (including UI styling, games, logic, visual assets). All intellectual property rights are reserved. 
          </p>
          <p>You must not:</p>
          <ul className="list-disc pl-6 space-y-1">
            <li>Republish material, code blocks, or custom SVGs from NAITIX AI.</li>
            <li>Sell, rent, or sub-license game mechanics or coaching dialogue modules.</li>
            <li>Reproduce, duplicate or copy material from NAITIX AI for secondary commercial resale.</li>
          </ul>

          <h2 className="text-xl font-bold text-gray-950 dark:text-white pt-4">8. Limitation of Liability</h2>
          <p>
            To the maximum extent permitted by applicable law, in no event shall NAITIX AI or its founders be liable for any direct, indirect, incidental, consequential, special, or exemplary damages arising out of or in connection with your use or inability to use the platform services, brain training modules, or AI recommendations.
          </p>
          ...
          <div className="p-4 bg-orange-50/30 rounded-2xl border border-orange-100/30 text-xs sm:text-sm space-y-1">
            <p className="font-bold text-gray-800">NAITIX AI Representative</p>
            <p>Email Inquiry: <strong><a href="mailto:help.naitix@gmail.com" className="text-orange-600 dark:text-orange-400 hover:underline">help.naitix@gmail.com</a></strong></p>
            <p>Corporate: NAITIX Tech Labs, Suite 480, San Francisco, CA 94107</p>
          </div>
        </article>
