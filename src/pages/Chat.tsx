    ...
    <AnimatePresence>
      {(attachment || replyingTo) && (
        <motion.div
          ...
          exit={{ opacity: 0, y: 10 }}
          className="absolute -top-16 left-2 right-2 bg-white/95 dark:bg-gray-800/95 backdrop-blur-md p-3 rounded-2xl shadow-2xl border border-gray-100 dark:border-gray-700 z-[45] flex items-center gap-3"
        >
    ...
    {editingMessage ? (
      ...
      >
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            type="submit"
            className="w-10 h-10 rounded-xl bg-green-500 flex items-center justify-center text-white shadow-md active:scale-95 transition-transform"
          >
